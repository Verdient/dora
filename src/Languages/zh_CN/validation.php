...
return [
    ...
    'unique_array' => ':attribute 不能包含重复的值',
    'decimal' => ':attribute 必须为包含 :decimal 位小数的十进制数字',
    'privilege_rule' => ':attribute 必须为有效且不重复的权限策略结构体',
    'snowflake' => ':attribute 必须为有效的雪花ID',
    'url_unless' => ':attribute 必须是一个有效的 URL',
    'max_rows' => ':attribute 除标题行外最多允许 :max 行',
    'min_rows' => ':attribute 除标题行外最少需要 :min 行',
